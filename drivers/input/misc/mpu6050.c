...
#define MPU6050_VDD_MIN_UV	2850000
#define MPU6050_VDD_MAX_UV	2850000
#define MPU6050_VLOGIC_MIN_UV	2600000
#define MPU6050_VLOGIC_MAX_UV	3300000
#define MPU6050_VI2C_MIN_UV	1800000
#define MPU6050_VI2C_MAX_UV	1800000
#else
